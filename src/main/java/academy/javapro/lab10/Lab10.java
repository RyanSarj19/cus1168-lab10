...
public class Lab10 {
    ...
    public static String replaceChar(String str) {
        ...
        // Replace 'x' with 'y'
        if (first == 'x') {
            return 'y' + replaceChar(rest);
        }
        // Otherwise, keep the character
        return first + replaceChar(rest);
    }
    ...
    public static String removeChar(String str) {
        ...
        // Skip 'x' characters
        if (first == 'x') {
            return removeChar(rest);
        }
        // Otherwise, keep the character
        return first + removeChar(rest);
    }
    ...
    public static String markPairs(String str) {
        ...
        // If identical, insert '*'
        if (first == second) {
            return first + "*" + markPairs(str.substring(1));
        }
    ...
    public static int substringLength(String str, String sub) {
        ...
        // If both, entire string qualifies
